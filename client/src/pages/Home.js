...
const LandingPage = () => {
  return (
    <div className="landing-page">
      <div fluid className="d-flex flex-column justify-content-center custom-bottom-margin align-items-center text-center bg-primary text-white" style={{minHeight: "60vh"}}>
        <h1 className="font-weight-bold" style={{fontSize: "60px"}}>Kia Ora!</h1>
      ...
      <footer className="mt-5 py-5 text-center bg-primary text-white">
        <p className="mb-0">&copy; EZGear 2023</p>
