...
function TermsAndConditions() {
  return (
    <div className="defaultPageLayout container">
      ...
      <div className="mb-4">
        <p className="mb-2">1. Acceptance of Terms</p>

        <p>
          By accessing or using the EZGear.app website, you acknowledge that you have read, understood, and agreed to these Terms and our Privacy Policy.
        </p>
      </div>
      ...
      <div className="mb-4">
        <p className="mb-2">8. Modification of Terms</p>

        <p>
          8.1 Changes to Terms: We reserve the right to modify these Terms at any time. Updated Terms will be posted on the EZGear.app platform. Your continued use of the website after changes are made constitutes your acceptance of the modified Terms.
        </p>
      </div>

      <div className="mb-4">
        <p className="mb-2">9. Copyright</p>

        <p>
          9.1 Copyright Statement: EZGear.app and its content are protected by copyright laws. All rights are reserved. You may not reproduce, distribute, modify, or create derivative works without our explicit permission.
        </p>
      </div>

      <div className="mb-4">
        <p className="mb-2">10. Governing Law</p>

        <p>
          10.1 Applicable Law: These Terms are governed by and construed in accordance with the laws of New Zealand, without regard to its conflict of law principles.
        </p>
      </div>

      <div>
        <p className="mb-2">11. Contact Us</p>

        <p>
          11.1 Questions: If you have any questions or concerns about these Terms or the EZGear.app platform, you can contact us at support@ezgear.app.
        </p>

        <p>
          By using the EZGear.app platform, you agree to these Terms and Conditions. Thank you for choosing EZGear.app!
        </p>
      </div>
    </div>
  );
